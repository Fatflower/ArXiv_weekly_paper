...
34. [Unsupervised Few-Shot Continual Learning for Remote Sensing Image Scene Classification](https://arxiv.org/abs/2406.18574)
35. [Pre-Trained Vision-Language Models as Partial Annotators](https://arxiv.org/abs/2406.18550)
36. [Evidential Concept Embedding Models: Towards Reliable Concept Explanations for Skin Disease Diagnosis](https://arxiv.org/abs/2406.19130)
37. [Segment Anything Model for automated image data annotation: empirical studies using text prompts from Grounding DINO](https://arxiv.org/abs/2406.19057)
38. [Structural Attention: Rethinking Transformer for Unpaired Medical Image Synthesis](https://arxiv.org/abs/2406.18967)
39. [AlignIT: Enhancing Prompt Alignment in Customization of Text-to-Image Models](https://arxiv.org/abs/2406.18893)
40. [CELLO: Causal Evaluation of Large Vision-Language Models](https://arxiv.org/abs/2406.19131)
41. [RAVEN: Multitask Retrieval Augmented Vision-Language Learning](https://arxiv.org/abs/2406.19150)
42. [SimTxtSeg: Weakly-Supervised Medical Image Segmentation with Simple Text Cues](https://arxiv.org/abs/2406.19364)
43. [Mamba or RWKV: Exploring High-Quality and High-Efficiency Segment Anything Model](https://arxiv.org/abs/2406.19369)